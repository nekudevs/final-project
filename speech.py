...
def recognize_speech(audio):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            model="gpt-4o",
            messages=[
                {"role": "system", "content": "You are the best voice assistant, skilled in explaining complex concepts with great accuracy and ease of understanding. Make sure to be concise and keep your setences short and limited to 150 words. You must not use any markdown in the responses, and make sure you sound like a human in the conversation, or at least a copy of Siri."},
...
if __name__ == "__main__":
        ...
        "xi-api-key": "9dc16a0c7aac225888b7cf6c1e58c00e"
        }
