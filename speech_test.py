...
def check_hello_spot():
    """Checks if recognized_text.txt contains the words 'hello spot'"""
    try:
        with open("recognized_text.txt", "r") as file:
            text = file.read().lower()
            return "hello spot" in text
    except FileNotFoundError:
        print("recognized_text.txt not found. Assuming 'hello spot' was not said.")
        return False
...
def main():
    ...
    if recognized_text and check_hello_spot():
        write_to_file(recognized_text)
        print("Hello user, activating hello_spot.py for you!")
        try:
            #hello_spot(options)
        ...
        print("Hello spot not recognised, exiting..")
